...
<body>
    ...
    <script>
        ...
        function checkDomainAvailability() {
            return fetch('https://map.emiia.keenetic.pro', { 
                method: 'HEAD',
                mode: 'no-cors',
                cache: 'no-cache'
        ...
        // Инициализация карты
        checkDomainAvailability().then(isOnline => {
            const styleUrl = isOnline 
                ? '/static/moscow_style_2.json' 
                : '/static/moscow_style_2_offline.json';
            
            console.log(`Using ${isOnline ? 'ONLINE' : 'OFFLINE'} style: ${styleUrl}`);
            ...
            // Fallback на оффлайн стиль при ошибке
            const map = new mapboxgl.Map({
                container: 'map', 
                style: '/static/moscow_style_2_offline.json',
                zoom: 13,
                center: [37.617, 55.755],
                pitch: 45,
                bearing: 0,
...
if __name__ == "__main__":
    ...
    print("Auto-switching: Online/Offline styles supported")
